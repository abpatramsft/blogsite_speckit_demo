...
Please note: There is no need to clone the repo, but the repo serves as a static output artefact of github spec-kit based development. You can follow the steps in each of the exercises to demonstrate spec-kit based development for your customer presentations
...
4. The video has a voice over explaining the various parts of development and highlighting the above mentioned aspects. You can always choose to mute and play it with your own voice over
...
3. The demo captures certain aspects about how spec-kit grounds its plans and instructions on the existing codebase and further ensures consistency with existing design patterns
4. This video also has a voice over explaining various techniques to ground the development process and fix bugs during the vibe-coding exercise
